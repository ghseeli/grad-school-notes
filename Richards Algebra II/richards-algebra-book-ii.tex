...
%Proof of 5.1.8 through 5.1.11 is missing

%The following lemma is actually 5.1.12
...
\begin{lemma}
If a (covariant) functor $T : \tn{Mod}_R \ra \tn{Mor}_R$ preserves the exactness of a short exact sequence, then it is exact.
\end{lemma}
