...
\begin{defi}
	$X$ is \emph{normal} if for all $A$,$B$ closed and disjoint, there exists $U$,$V$ open, disjoint with $A \subseteq U$ and $B \subseteq V$.  (The "normal" condition is also called "Axiom T4".  But this is *not* the same as being a T4 space.  A T4 space is, by definition, T2 + Axiom T4.)
\end{defi}
\begin{rmk}
