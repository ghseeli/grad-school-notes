...
\end{proof}
  ...
  \end{example*}
  We have a canonical map: \funcdeclaration{j}{R}{D^{-1}R}{r}{\frac{r}{1}}
  ...
  \begin{prop}Given a commutative ring \(R\) with unity.
    ...
    \item There is a canonical map:  \funcdeclaration{j}{R}{D^{-1}R}{r}{\frac{r}{1}} under which \(j(D) \subseteq
      D^{-1}R^\times\).
