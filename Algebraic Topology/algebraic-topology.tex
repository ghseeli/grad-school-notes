...
When using normal subgroups that correspond to covering spaces, you get maximal symmetry. It looks the same at every point. It's the same as taking universal cover and modding out by relations.

When you use regular subgroups that correspond to covering spaces, you cannot do the modding out trick.  (or maybe you can only do it locally).  It won't be symmetric.  It will look like example (a) in Hatcher for $S1 \vee S1$.
