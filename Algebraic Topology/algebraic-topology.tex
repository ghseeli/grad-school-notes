...
\begin{rmk}
  Technically, Delta-complexes ($\Delta$-complexes) need to be built from triangles.  So the following are not Delta complexes:
  \begin{itemize}
    \item \includegraphics[scale=0.2]{images/not-delta-complex1}
    \item \includegraphics[scale=0.2]{images/not-delta-complex2} ((actually, i see no reason why this can't be a delta complex.))
    \item \includegraphics[scale=0.2]{images/not-delta-complex3}
  \end{itemize}
  But they still qualify as simplicial complexes.

  On the other hand, $\Delta$-complexes allow you to glue vertices together, but simplicial complexes do not. ((John Harnois))
\end{rmk}
