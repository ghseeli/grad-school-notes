...
$\pi\left( \frac{X_1 \union D^2}{\sim} \right) \isom \frac{\fund(B) * \fund(A)}{A \cap B} \isom \frac{\fund(x_1)}{[\phi] = 1}$, where * denotes the free group product. (( i think he meant $\fund$ instead of $\pi$ at the beginning))
