...
\mydate{do}{26}{4}{2017}
\renewcommand{\homl}[1][m]{H_{#1}}
\renewcommand{\rhoml}[1][m]{\widetilde{H}_{#1}}
\renewcommand{\rchains}[1][m]{\widetilde{C}_{#1}}
